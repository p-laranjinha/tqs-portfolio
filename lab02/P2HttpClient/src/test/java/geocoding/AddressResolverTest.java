...
class AddressResolverTest {
    ...
    public void whenBadCoordidates_throwBadArrayindex() throws IOException, URISyntaxException, ParseException {
        when(httpClient.get(contains("-1000.000000%2C-1000.000000"))).thenThrow(IndexOutOfBoundsException.class);

        assertThrows(IndexOutOfBoundsException.class, ()->resolver.findAddressForLocation(-1000,-1000));
    }
